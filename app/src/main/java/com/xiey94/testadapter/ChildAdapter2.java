...
public class ChildAdapter2 extends RecyclerView.Adapter<ChildAdapter2.ChildViewHolder> {
    ...
    private List<ChildBean2> data;

    public ChildAdapter2(List<ChildBean2> data) {
        this.data = data;
    }
    ...
    public ChildViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_child_2, viewGroup, false);
